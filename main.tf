# Root Terraform configuration to provision full AWS infrastructure
...
module "load_balancer" {
  ...
  aws_lb_security_groups      = [module.vpc.security_group_id]
  aws_lb_subnets              = module.vpc.public_subnet_ids
}
